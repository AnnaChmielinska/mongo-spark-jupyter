...
spark = SparkSession.\
        ...
        config("spark.mongodb.input.uri","mongodb://mongo1:27017/Stocks.Source?replicaSet=rs0").\
        config("spark.mongodb.output.uri","mongodb://mongo1:27017/Stocks.Source?replicaSet=rs0").\
